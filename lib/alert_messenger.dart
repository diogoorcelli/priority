...
class AlertMessengerState extends State<AlertMessenger>
  ...
  ValueNotifier<Widget?> alertWidget = ValueNotifier(null);
  AlertPriority? currentAlertPriority;
  ...
  void showAlert({required Alert alert}) {
    if (alertWidget.value == null ||
        alert.priority.value > currentAlertPriority!.value) {
      setState(() {
        alertWidget.value = alert;
        currentAlertPriority = alert.priority;
      });
      controller.forward();
    }
  }
        ...
        return Stack(
          ...
          children: [
            ...
            Positioned(
              ...
              left: 0,
              right: 0,
              child: alertWidget.value ?? const SizedBox.shrink(),
            ),
          ],
        );
      },
